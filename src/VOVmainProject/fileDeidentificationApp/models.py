...
class User(models.Model):
    ...
    userclass1 = models.CharField(db_column='userClass1', max_length=255, blank=True, null=True)  # Field name made lowercase.
    userclass2 = models.CharField(db_column='userClass2', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class UploadedImage(models.Model):
    image = models.ImageField(upload_to='upload_first/')
